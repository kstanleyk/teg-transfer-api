...
//    {
//        CreateMap<Domain.Entity.Core.ExchangeRate, ExchangeRateDto>()
...
//            .ForMember(dest => dest.RateDescription, opt => opt.MapFrom(src => src.GetRateDescription()))
//            .ForMember(dest => dest.RateInverseDescription, opt =>
//                opt.MapFrom((src, dest) => SafeGetInverseRateDescription(src)))
...
//    private static string SafeGetInverseRateDescription(Domain.Entity.Core.ExchangeRate exchangeRate)
//    {
//        if (exchangeRate == null) return string.Empty;

//        try
//        {
//            return exchangeRate.GetInverseRateDescription();
//        }
//        catch
//        {
//            return string.Empty;
...
public class ExchangeRateProfile : Profile
{
    public ExchangeRateProfile()
    {
        CreateMap<ExchangeRate, ExchangeRateDto>()
            ...
            .ForMember(dest => dest.Source, opt => opt.MapFrom(src => src.Source))
            .ForMember(dest => dest.RateDescription, opt => opt.MapFrom(src => src.GetRateDescription()))
            .ForMember(dest => dest.RateInverseDescription, opt => opt.MapFrom(src => src.GetInverseRateDescription()))
            .ForMember(dest => dest.ClientGroupName, opt => opt.MapFrom(src => src.ClientGroup != null ? src.ClientGroup.Name : null))
            .ForMember(dest => dest.ClientName, opt => opt.MapFrom(src => src.Client != null ? src.Client.FullName : null))
            .ForMember(dest => dest.RateTypeDescription, opt => opt.MapFrom(src => GetRateTypeDescription(src.Type)));
    }
