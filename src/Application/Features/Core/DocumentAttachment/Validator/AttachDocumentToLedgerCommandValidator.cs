...
public class AttachDocumentToLedgerCommandValidator : AbstractValidator<AttachDocumentToLedgerCommand>
{
    public AttachDocumentToLedgerCommandValidator()
    {
        ...
        // Business rules delegated to domain entity
        // Note: We don't validate content type or file size here - 
        // that's the domain entity's responsibility
    }
