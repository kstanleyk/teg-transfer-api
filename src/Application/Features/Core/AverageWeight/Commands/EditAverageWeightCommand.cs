...
{
    public async Task<EditAverageWeightCommandResponse> Handle(EditAverageWeightCommand request, 
        CancellationToken cancellationToken)
    {
        ...
        var averageWeight = Domain.Entity.Core.AverageWeight.Create(awr.Estate, awr.Block, awr.Weight,
            awr.EffectiveDate, awr.Status, DateTime.UtcNow);
