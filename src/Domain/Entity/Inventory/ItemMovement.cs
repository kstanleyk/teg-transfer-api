...
public class ItemMovement : Entity<string>
{
    ...
    public static ItemMovement Create(string lineNum, string description, string item, DateTime transDate,
        string transTime, string sense, double qtty, string sourceId, string sourceLineNum, DateTime? createdOn = null)
    {
        ...
        if (sense != "IN" && sense != "OUT")
            throw new ArgumentException("Sense must be either 'IN' or 'OUT'.", nameof(sense));
