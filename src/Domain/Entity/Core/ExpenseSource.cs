...
public class ExpenseSource : Entity<string>
{
    public Guid? PublicId { get; private set; }
    public string Description { get; private set; } = null!;
    public DateTime CreatedOn { get; private set; }

    protected ExpenseSource()
    {
    }

    public static ExpenseSource Create(string id, string description, DateTime? createdOn = null)
    {
