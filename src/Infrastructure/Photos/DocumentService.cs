...
public class DocumentService : IDocumentService
{
    ...
    //public async Task<Resource> GetFileInfo(string publicId)
    //{
    //    try
    //    {
    ...
    //            {
    //                ResourceType = ResourceType.Image // Adjust based on your needs
    //            });
    ...
    //    catch (Exception ex)
    //    {
    //        _logger.LogError(ex, "Error getting file info from Cloudinary. PublicId: {PublicId}", publicId);
    //        throw;
    //    }
    //}
}
...
//    public DocumentService(IOptions<CloudinarySettings> config)
//    {
