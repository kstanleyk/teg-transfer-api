        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    address_street = table.Column<string>(type: "character varying(75)", maxLength: 75, nullable: false),
                    ...
                    address_zip_code = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false),
                    address_quarter = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    address_landmark = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    public_id = table.Column<Guid>(type: "uuid", nullable: false),
                    created_on = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
                    trans_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    packaging_type_id = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    packaging_type_bottling_type_size_in_liters = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    packaging_type_bottling_type_display_name = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    packaging_type_units_per_box = table.Column<int>(type: "integer", nullable: false),
                    packaging_type_display_name = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    public_id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    created_on = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_product_movement", x => new { x.id, x.line_num });
                    table.ForeignKey(
                        name: "fk_product_movement_order_order_id",
                        column: x => x.order_id,
                        principalSchema: "inventory",
                        principalTable: "order",
                        principalColumn: "id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_product_movement_order_id",
                schema: "inventory",
                table: "product_movement",
                column: "order_id");

            migrationBuilder.CreateIndex(
                name: "ix_product_movement_public_id",
                schema: "inventory",
                table: "product_movement",
                column: "public_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_product_movement_source_id_line_num_item",
                schema: "inventory",
                table: "product_movement",
