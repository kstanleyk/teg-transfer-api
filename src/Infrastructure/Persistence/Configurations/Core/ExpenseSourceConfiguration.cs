...
{
    public void Configure(EntityTypeBuilder<ExpenseSource> entity)
    {
        ...
        entity.Property(e => e.Description).IsRequired().HasMaxLength(35).IsUnicode(false);

        entity.ToTable("expense_source", "core");
    }
}