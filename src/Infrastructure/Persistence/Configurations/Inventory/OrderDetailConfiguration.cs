...
public class OrderDetailConfiguration : IEntityTypeConfiguration<OrderDetail>
{
    public void Configure(EntityTypeBuilder<OrderDetail> builder)
    {
        ...
        builder.HasKey(d => new { d.OrderId, d.LineNum });

        builder.Property(d => d.OrderId).HasMaxLength(15).IsRequired();
        ...
        builder.Property(d => d.TransDate).IsRequired();
        ...
        builder.Property(d => d.ReceiveDate);
    }
}